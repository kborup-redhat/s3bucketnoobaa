...
$c['page-header'] = getenv_default('PAGE_HEADER', 'VPSEC Nightwatch reports');
...
$c['s3-access-key'] = Ttu5QcGq78aLBK7jvNxv;
$c['s3-secret-key'] = IEDDGW4eNYJq7jKe6OK5ci1nSa8xYNQtQvALeppi;
...
// Bucket
$c['bucket-name'] = web-bucket-4cf101e4-5ca2-400b-ae1e-5345a1b4a747;
